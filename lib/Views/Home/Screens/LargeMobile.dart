...
class LargeMobile extends StatelessWidget {
  BoxConstraints constraints;
  User user;
  LargeMobile({required this.constraints, required this.user});
              ...
              children: [
                ...
                StartAnimation(
                  ...
                  widget: Text(
                    ...
                    style: TextStyle(
                        fontSize: small_medium_phone_tilte,
                ...
                StartAnimation(
                  ...
                  widget: Text(user.email!,
                      style: TextStyle(
                          fontSize: small_medium_phone_tilte - 12,
                          fontWeight: FontWeight.bold)),
                ),
                space_height(),
                StartAnimation(
                  widget: DefaultButton(
                      textfontsize: small_medium_phone_tilte - 12,
                      controller: () {
