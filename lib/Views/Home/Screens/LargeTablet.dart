...
class LargeTablet extends StatelessWidget {
  BoxConstraints constraints;
  User user;
  LargeTablet({required this.constraints, required this.user});
              ...
              children: [
                ...
                StartAnimation(
                  ...
                  widget: Text(user.email!,
                      style: TextStyle(
                          fontSize: tablet_subtilte3 - 10,
                          fontWeight: FontWeight.bold)),
                ),
                space_height(),
                StartAnimation(
                  widget: DefaultButton(
                      textfontsize: tablet_subtilte3 - 10,
                      controller: () {
